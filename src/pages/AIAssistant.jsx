...
const AIAssistant = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const systemPrompt = `You are an Indian emergency response AI assistant. You help people during emergencies like floods, earthquakes, fires, medical emergencies, etc. Provide clear, concise, actionable steps with relevant emergency contact numbers when needed. Always prioritize safety and immediate action. User question: ${messageToSend}`;
      ...
      const errorMessageContent = "I apologize, but I'm having trouble connecting right now. Please check your API key or try again. Contact emergency services directly if this is urgent.";
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50">
          <div className="flex flex-col space-y-3">
            ...
            <form onSubmit={handleSendMessage} className="flex space-x-2 items-center">
              ...
              <button type="submit" disabled={isLoading || !inputMessage.trim()} className="p-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-400 text-white rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500">
